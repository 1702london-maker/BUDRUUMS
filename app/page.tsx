      ...
      <div className="bg-gl border-y border-br">
        <div className="max-w-screen-2xl mx-auto px-5 sm:px-8 lg:px-14 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[13.5px] text-t2">
            ...
            {" "}or call{" "}
            <a href="tel:+442046523032" className="text-t1 font-medium border-b border-t1">
              +44 (204) 652 3032
            </a>
          </p>
          <div className="flex flex-wrap items-center gap-6">
            {[
              ...
              { href: "tel:+442046523032", icon: <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.38 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.13 6.13l1.27-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>, extra: null, label: "+44 (204) 652 3032" },
